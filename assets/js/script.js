    ...
    .then(function (response) {
      if (response.ok) {
        response.json().then(function (data) {
          ...
          // Call the displayForecast function to render the forecast cards
          displayForecast();
        });
      } else {
...
let displayForecast = function () {
  ...
  // Check if forecastCard exists before clearing its inner HTML
  if (typeof forecastCard !== "undefined") {
