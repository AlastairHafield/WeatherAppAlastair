...
//
  function handleSearchFormSubmit(event) {
    ...
    var searchInputVal = document.querySelector('#search-input').value;
      ...
      var queryString = 'https://api.openweathermap.org/data/2.5/weather?q=' + searchInputVal + '&units=metric&APPID=554388edb86f83b04c10657b0a21f79c'
  ...
  const displayData = function(){
    ...
    let iconString = ('<img src=http://openweathermap.org/img/wn/' + object.weather[0].icon + '@4x.png width=50px height=50px alt>')
    ...
    weatherData.classList = 'result-body flex-row justify-space-between align-center'
    weatherData.setAttribute('class', 'result-body')
    weatherData.innerHTML = ('Temp: ' + object.main.temp + '\u00B0C' + " / " + 'Wind: ' + object.wind.speed + ' MPH' + " / " + 'Humidity: ' + object.main.humidity + '%')
    ...
    var forecastUrl = "https://api.openweathermap.org/data/2.5/forecast?q=" + object.name + "&units=metric&APPID=554388edb86f83b04c10657b0a21f79c"
 ...
 // var geoCode = 'http://api.openweathermap.org/geo/1.0/direct?q=' + searchInputVal + '&limit=5&units=metric&APPID=554388edb86f83b04c10657b0a21f79c'
 //   fetch(geoCode)
   // .then(function (response){
     // if (response.ok) {
       // response.json().then (function(data) {
         // const coords = JSON.stringify(data);
